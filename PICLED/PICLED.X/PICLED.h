 ...
 * Author: MCook
 *
 * Created on January 8, 2015, 10:39 AM
 * 
 * Purpose: Configuration Bit Settings for device (PIC18F45K50)
 */

// Created with MPLABX Configuration Bit Settings / 'PIC Memory Views' option
